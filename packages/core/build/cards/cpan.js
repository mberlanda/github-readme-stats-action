...
const renderCPAN = (data, options = {}) => {
  ...
  return renderExternalCard({
    defaultTitle: title,
    titlePrefixIcon: PERL_ICON,
    summary: [
      {
        label: "PAUSE ID",
        value: pauseid,
        link: `https://metacpan.org/author/${encodeURIComponent(pauseid)}`,
      },
