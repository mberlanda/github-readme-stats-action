...
const statsFetcher = async ({
  ...
  while (hasNextPage) {
    ...
    fetchedPages++;
    // MIN_STARS_TO_PAGINATE: minimum stars a repo must have for pagination to
    // continue. Default 1 (upstream behaviour). Set to 0 to paginate past 0-star repos.
    const minStarsToPaginate = parseInt(
